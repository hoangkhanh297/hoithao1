		...
		<div class="wrapper">
			<table cellspacing="0" cellpadding="0" border="0"
				...
				<tr valign="top">
					<td>
						<div id="pnCenter">
							<div id="pnCenterDisplay" style="width: 692px; float: left; min-height:600px">
            ...
            <div style="margin-left: 5px; margin-bottom: 10px;">
                <div class="ct_tin_display">
                    <div class="articleTitle">
                        <a href="redirect:/">${article.name }</a>
                    </div>
                    <div style="float:left;width: 100%; margin: 5px 5px 5px 10px;display: none;">
                        <span style="font-weight: bold;font-style: italic">${article.author }</span>:
                    </div>
